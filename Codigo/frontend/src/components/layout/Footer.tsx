    ...
    <footer className="cd-footer">
      <div className="footer-main">
        ...
        <div className="footer-contribua">
          <h2 className="footer-col-title">Campanha Nova Sede</h2>
        ...
        <div className="footer-social">
          <a
            href="https://www.youtube.com/@casadosdiscipuloscomunidad1004"
            target="_blank"
          ...
          <a
            href="https://www.instagram.com/casadosdiscipulos/"
            target="_blank"
            rel="noopener noreferrer"
            className="footer-social-link"
          ...
          <a
            href="https://www.facebook.com/casadosdiscipulos/?locale=pt_BR"
            target="_blank"
            rel="noopener noreferrer"
            className="footer-social-link"
            aria-label="Facebook"
