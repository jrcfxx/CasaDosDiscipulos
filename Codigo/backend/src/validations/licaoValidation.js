...
/**
 * Schema de validação para criação de lição
 */
export const createLicaoSchema = Joi.object({
  titulo: Joi.string().min(3).max(255).required().messages({
    "string.empty": "Título da lição é obrigatório",
...
/**
 * Schema de validação para atualização de lição
 */
export const updateLicaoSchema = Joi.object({
